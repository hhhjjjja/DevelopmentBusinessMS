...
<c:set var="pageTitle"><spring:message code="pms.workprogress.workTitle"/></c:set>
<html lang="ko">
<head>
...
function fn_egov_pageview(pageNo){
   ...
   document.listForm.action = "<c:url value='/pms/workprogress/WorkListView.do'/>";
...
function fn_egov_regist_WorkPmsProgress(){
   location.href = "<c:url value='/pms/workprogress/WorkRegist.do' />";
}
/* ********************************************************
 * 상세회면 처리 함수
 ******************************************************** */
function fn_egov_detail_WorkPmsProgress(proId){
   ...
   varForm.action           = "<c:url value='/pms/workprogress/WorkDetail.do'/>";
      ...
      <ul>
         ...
         <!--조회-->
            ...
            <span class="btn_b"><a href="#noscript" onclick="fn_egov_search_WorkPmsProgress(); return false;" title="<spring:message code="button.inquire" />"><spring:message code="button.inquire" /></a></span><!-- 조회 버튼 -->
             <!--선정과제 등록 -->
           <!-- <input class="s_btn" type="submit" value="<spring:message code="button.create" />" title="<spring:message code="button.create" />" onclick="fn_egov_regist_WorkPmsProgress(); return false;" />-->
