...
function fn_egov_modify(){
	...
	varForm.action           = "<c:url value='/pms/workprogress/WorkUpdate.do'/>";
...
function fn_egov_delete(){
	if (confirm("<spring:message code='common.delete.msg'/>")) {
		var varForm				 = document.all["Form"];
		varForm.action           = "<c:url value='/pms/workprogress/WorkRemove.do'/>";
		varForm.proId.value   = "${result.proId}";
		varForm.submit();
	}
}
...
<div class="wTableFrm">
	...
	<table class="wTable">
		...
		<tr>
			<th><spring:message code="pms.workprogress.workName" /> <span class="pilsu">*</span></th><!-- 과제연도 -->
			<td class="left">
				${result.proDate}
			</td>
		</tr>
	...
	<!-- 하단 버튼 -->
	<div class="btn">
		<input class="s_submit" type="submit" value="수정" onclick="fn_egov_modify(); return false;" /><!-- 수정 -->
