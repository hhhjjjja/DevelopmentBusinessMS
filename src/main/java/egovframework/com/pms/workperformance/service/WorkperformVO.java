 ...
 *  -------      --------    ---------------------------
 *  2020.10.30   옥승배               최초생성
 *  2020.11.05   윤태준               BoardVo 복붙
 *   
 *
 * </pre>
 */
@SuppressWarnings("serial")
public class WorkperformVO extends WorkPerformance implements Serializable  {
     ...
     *            the bbsNm to set
     */
    public void setBbsNm(String taskNm) {
	this.taskNm = taskNm;
    }
